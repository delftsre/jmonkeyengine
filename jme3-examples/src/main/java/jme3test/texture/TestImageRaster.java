...
public class TestImageRaster extends SimpleApplication {
    ...
    private Image convertImage(Image image, Format newFormat) {
        ...
        ImageRaster sourceReader = ImageRasterFactory.create(image);
        ImageRaster targetWriter = ImageRasterFactory.create(convertedImage);
    ...
    private Image createTestImage() {
        ...
        ImageRaster io = ImageRasterFactory.create(testImage);
