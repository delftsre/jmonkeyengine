...
public class GeometryBatchFactory {
    ...
    private static void doTransformVerts(FloatBuffer inBuf, int offset, FloatBuffer outBuf, Matrix transform) {
    ...
    private static void doTransformNorms(FloatBuffer inBuf, int offset, FloatBuffer outBuf, Matrix transform) {
    ...
    private static void doTransformTangents(FloatBuffer inBuf, int offset, int components, FloatBuffer outBuf, Matrix transform) {
